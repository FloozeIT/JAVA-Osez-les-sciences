...
public class InterfaceGlobaleTutController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
		...
		FlowPane contenu;
		try {
			contenu = FXMLLoader.load(getClass().getResource("contenuTuteur.fxml"));
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////                
        try {
            ...
            Logger.getLogger(InterfaceGlobaleTutController.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void clic2(ActionEvent event) throws Exception {
        ...
        switch(btn.getText())
        {
            case "LUNDI":drawerNameP="Lundi"; 
            			 ...
            			 ligne.setEndX(117.9);
            			 FlowPane contenuLP = FXMLLoader.load(getClass().getResource("contenuTuteur.fxml"));
            ...
            case "MARDI":drawerNameP="Mardi";
            			 ligne.setStartX(117.9);
			 			 ligne.setEndX(353.7);
            			 FlowPane contenuMAP = FXMLLoader.load(getClass().getResource("contenuTuteur.fxml"));
            ...
            case "MERCREDI": drawerNameP="Mercredi";
            				ligne.setStartX(353.7);
			 			 	ligne.setEndX(589.5);
	            			FlowPane contenuMEP = FXMLLoader.load(getClass().getResource("contenuTuteur.fxml"));
			...
			case "JEUDI": drawerNameP="Jeudi";
						 ...
						 ligne.setEndX(825.3);
                		 FlowPane contenuJP = FXMLLoader.load(getClass().getResource("contenuTuteur.fxml"));
			...
			case "VENDREDI": drawerNameP="Vendredi";
            			    ...
            			    FlowPane contenuVP = FXMLLoader.load(getClass().getResource("contenuTuteur.fxml"));
