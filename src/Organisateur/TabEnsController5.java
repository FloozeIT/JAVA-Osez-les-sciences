...
public class TabEnsController5 implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        for(int i=1; i<sheet.getColumn(0).length;i++){
        	if(sheet.getCell(1,i).getContents().equals(contenuConsultReserController.choiceHeureP.getValue()) && sheet.getCell(2,i).getContents().equals(contenuConsultReserController.choiceMatP.getValue()))
